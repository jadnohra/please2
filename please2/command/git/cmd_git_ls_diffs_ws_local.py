...
class CommandGitLsDiffsWsLocal(Command):
    ...
    def run_match(self, args, params):
        root = get_ws_modifs_tree(args, params, ws_cache=True, cache_local=True)
        return Match({self.layer_name():root})

reg_cmd.register_command(CommandGitLsDiffsWsLocal())
